...
export const BASE_URLS = {
  ...
  STUDENT_LMS: process.env.NEXT_PUBLIC_STUDENT_LMS_URL || 'http://localhost:3001',
} as const;
...
export const API_ENDPOINTS = {
  ...
  INSTRUCTOR: {
    ...
    BATCH_COURSES: (batchId: string) => `/api/instructor/batches/${batchId}/courses`,
    ...
    ANALYTICS: {
      ...
      BATCH_COURSE_PROGRESS: (batchId: string, courseId: string) => `/api/instructor/batches/${batchId}/courses/${courseId}/progress`,
      BATCH_COURSE_TESTS: (batchId: string, courseId: string) => `/api/instructor/batches/${batchId}/courses/${courseId}/tests`,
      BATCH_COURSE_TEST_STATS: (batchId: string, courseId: string) => `/api/instructor/batches/${batchId}/courses/${courseId}/test-stats`,
    ...
    TEST_MANAGEMENT: {
      ...
      SUBMISSION_BY_ID: (id: string) => `/api/instructor/test-management/submissions/${id}`,
    },

    // Progress Tracking
    PROGRESS: {
      COURSE: (courseId: string) => `/api/instructor/progress/courses/${courseId}`,
      BATCH: (batchId: string) => `/api/instructor/progress/batches/${batchId}`,
      STUDENT: (studentId: string) => `/api/instructor/progress/students/${studentId}`,
    },
  },
  ...
  BATCHES: {
    ...
    ASSIGN_COURSE: (batchId: string, courseId: string) => `/api/batches/${batchId}/courses/${courseId}`,
  },
