            ...
            try {
                ...
                const studentsData = progressData.map((student: any) => {
                    ...
                    return {
                        ...
                        email:
                            student.email || `${student.username}@domain.com`,
                        courseProgress: [
                            {
                                courseId: courseId,
                                courseName:
                                ...
                                timeSpent:
                                    student.timeSpent || overallProgress * 2, // 2 hours per 10% progress
                        ...
                        lastActive:
                            ...
                            new Date().toISOString(),
                        totalTimeSpent:
                            student.timeSpent || overallProgress * 2,
                        coursesCompleted:
                            student.status === "completed" ? 1 : 0,
                        coursesEnrolled: 1,
