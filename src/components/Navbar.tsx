      ...
      <div className="max-w-[95vw] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <div className="w-8 h-8 bg-gradient-to-br from-violet-600 to-indigo-600 rounded-lg flex items-center justify-center mr-3">
          ...
          {status === "authenticated" ? (
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white/95 backdrop-blur-md rounded-2xl shadow-xl border border-gray-200/80 py-2 z-50 animate-scale-in">
                  ...
                  <div className="py-2">
                    <button className="flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-violet-50/80 hover:text-violet-600 transition-all duration-200 group">
                      <FiUser className="h-4 w-4 mr-3 text-gray-400 group-hover:text-violet-500" />
                      View Profile
                    </button>
                    <button className="flex items-center w-full px-4 py-2.5 text-sm text-gray-700 hover:bg-violet-50/80 hover:text-violet-600 transition-all duration-200 group">
                      <FiSettings className="h-4 w-4 mr-3 text-gray-400 group-hover:text-violet-500" />
                      Settings
                    </button>
                  </div>
            ...
            <button
              ...
              className="bg-violet-600 text-white text-sm px-4 py-2 rounded-xl hover:bg-violet-700 transition-all duration-200"
            >
              Sign In
            </button>
          )}
